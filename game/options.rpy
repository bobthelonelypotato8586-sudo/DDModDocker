...
init python:
    ...
    build.package("ddmd8-win",'zip','windows linux renpy mod all',description="Ren'Py 8 DDMD Build: Windows/Linux")
    build.package("ddmd8-mac",'app-zip','mac renpy mod all',description="Ren'Py 8 DDMD Build: macOS")
